...
("춘천 호수길 환경 미션", "춘천 호수길에서 환경을 보호하고 쓰레기를 줍는 활동을 진행합니다. 함께 자연을 깨끗하게 만들어요!", "강원도 춘천시 춘천호수길", 37.8792, 127.7353, 15, "2025-03-01", "2025-03-02", 150, 1),
("춘천 의암호 주변 청소", "의암호 주변에서 쓰레기를 줍고 환경을 보호하는 캠페인입니다. 깨끗한 자연을 위해 함께 참여해 주세요.", "강원도 춘천시 의암호", 37.8830, 127.7812, 10, "2025-03-02", "2025-03-03", 100, 2),
("춘천 소양강댐 환경 보호", "소양강댐 주변에서 쓰레기를 줍고 자연을 보호하는 활동을 함께 진행합니다.", "강원도 춘천시 소양강댐", 37.9336, 127.7205, 20, "2025-03-03", "2025-03-04", 200, 3),
("춘천 남이섬 청소 활동", "남이섬에서 쓰레기 줍기 활동을 진행하며 아름다운 섬을 보호해요!", "강원도 춘천시 남이섬", 37.7949, 127.5403, 18, "2025-03-04", "2025-03-05", 250, 4),
("춘천에서 쓰리기도 줍고 닭갈비도 같이 먹어요 숯불닭갈비로요!!","춘천은 정말 아름다운 지역으로 먹거리도 많고 걸을 수 있는 거리도 많습니다 많이 모여서 친해지며 맛난거 먹으면 좋을 것 같습니다.", "강원도 춘천시 강촌리", 37.8699, 127.7254, 12, "2025-03-05", "2025-03-06", 150, 1),
("춘천 두루미 생태공원 청소", "두루미 생태공원에서 환경 보호 활동을 하며 자연을 보호하는 미션을 수행합니다.", "강원도 춘천시 두루미공원", 37.8803, 127.7268, 10, "2025-03-06", "2025-03-07", 180, 2),
("춘천 석파산 트레킹 및 청소", "석파산 트레킹을 하면서 쓰레기를 줍고 환경을 보호하는 활동에 동참하세요.", "강원도 춘천시 석파산", 37.8721, 127.7483, 8, "2025-03-07", "2025-03-08", 120, 3),
("춘천 중도섬 환경 정화 활동", "중도섬에서 자연을 보호하고 쓰레기를 줍는 활동을 함께 진행합니다.", "강원도 춘천시 중도섬", 37.8763, 127.7391, 10, "2025-03-08", "2025-03-09", 150, 4),
("춘천 공지천 청소 캠페인", "공지천에서 쓰레기 줍기 활동을 통해 청정한 자연을 지키는 캠페인입니다.", "강원도 춘천시 공지천", 37.8799, 127.7230, 12, "2025-03-09", "2025-03-10", 100, 1),
("춘천 송암스포츠타운 환경 보호", "송암스포츠타운에서 환경 보호 활동을 통해 깨끗한 공간을 유지해요.", "강원도 춘천시 송암동", 37.8681, 127.7104, 15, "2025-03-10", "2025-03-11", 150, 2),
...
("강릉 송정 해변에서 쓰레기 줍기", "강릉 송정 해변에서 함께 쓰레기를 줍고 청정한 해변을 유지해보세요.", "강원도 강릉시", 37.5432, 128.7001, 6, "2025-02-19", "2025-02-20", 0, 1),
("서울 홍제천 환경 미션", "홍제천을 청소하며 환경 보호를 실천하는 활동입니다. 함께 참여해주세요!", "서울시 서대문구", 37.5767, 126.9354, 8, "2025-02-20", "2025-02-21", 0, 2),
("부산 동백섬에서 자연 보호 캠페인", "부산 동백섬에서 환경 보호 활동에 참여하세요. 쓰레기를 줍고 자연을 지키는 일입니다.", "부산시 부산진구", 35.1640, 129.0912, 10, "2025-02-21", "2025-02-22", 0, 3),
("서울 시청 앞 광장에서 청소 활동", "서울 시청 앞 광장에서 쓰레기 줍기와 함께 환경을 지키는 미션에 참여하세요!", "서울시 중구", 37.5665, 126.9780, 12, "2025-02-22", "2025-02-23", 0, 4),
("부산 태종대 자연 보호 활동", "부산 태종대에서 자연을 보호하며 쓰레기 줍는 활동에 동참해 주세요.", "부산시 영도구", 35.0739, 129.1031, 7, "2025-02-23", "2025-02-24", 0, 1),
("서울 강남구 환경 정화", "강남구 거리에서 쓰레기를 줍고 함께 환경을 깨끗하게 만드는 활동입니다.", "서울시 강남구", 37.5172, 127.0473, 15, "2025-02-24", "2025-02-25", 10, 2),
("대전 한밭수목원에서 환경 정화", "대전 한밭수목원에서 자연 보호 활동을 진행합니다. 많은 참여 부탁드립니다.", "대전광역시 중구", 36.3413, 127.3848, 5, "2025-02-25", "2025-02-26", 0, 3),
("경주 보문호수 주변 청소", "경주 보문호수 근처에서 쓰레기 줍기 활동을 합니다. 자연을 함께 지켜요!", "경북 경주시", 35.8537, 129.2565, 8, "2025-02-26", "2025-02-27", 0, 4),
("인천 월미도에서 해변 청소", "인천 월미도에서 해변 청소 및 환경 보호 활동을 진행합니다. 함께 참여해주세요!", "인천시 중구", 37.4750, 126.6187, 6, "2025-02-27", "2025-02-28", 0, 1),
("부산 기장군 일광해수욕장 쓰레기 줍기", "기장군 일광해수욕장에서 쓰레기 줍기 활동을 함께 합니다. 환경 보호에 동참하세요!", "부산시 기장군", 35.3012, 129.1795, 4, "2025-02-28", "2025-03-01", 0, 2),
("울산 태화강에서 환경 미션", "울산 태화강에서 환경을 정화하는 활동에 참여하고, 태화강을 깨끗하게 만들어요.", "울산광역시", 35.5290, 129.3144, 9, "2025-03-01", "2025-03-02", 0, 3),
("서울 올림픽 공원 환경 보호 활동", "올림픽 공원에서 함께 환경 보호 미션을 수행하고 깨끗한 서울을 만드세요.", "서울시 송파구", 37.5153, 127.1210, 10, "2025-03-02", "2025-03-03", 0, 4),
("강원도 평창에서 자연 보호 활동", "평창의 아름다운 자연을 보호하며 환경 정화 활동을 함께 합니다.", "강원도 평창군", 37.4513, 128.2800, 7, "2025-03-03", "2025-03-04", 0, 1),
("전주 한옥마을에서 쓰레기 줍기", "전주 한옥마을 주변에서 쓰레기를 줍고 깨끗한 환경을 만들어요.", "전북 전주시", 35.8245, 127.1480, 8, "2025-03-04", "2025-03-05", 0, 2),
("서울 동대문구 환경 미션", "동대문구에서 쓰레기 줍기 활동을 진행합니다. 함께 환경 보호에 참여해요!", "서울시 동대문구", 37.5740, 127.0389, 12, "2025-03-05", "2025-03-06", 0, 3),
("광주 무등산 환경 보호 활동", "광주 무등산에서 환경 보호 활동을 진행합니다. 자연을 함께 지켜요!", "광주광역시", 35.1570, 126.9117, 6, "2025-03-06", "2025-03-07", 0, 4),
("충주호 주변 청소 활동", "충주호 주변에서 쓰레기를 줍고 깨끗한 환경을 유지하는 활동입니다.", "충청북도 충주시", 37.0387, 127.9354, 7, "2025-03-07", "2025-03-08", 0, 1),
("양평 두물머리에서 자연 보호 활동", "양평 두물머리에서 자연을 보호하며 함께 환경 정화 활동에 참여하세요.", "경기도 양평군", 37.5118, 127.4879, 5, "2025-03-08", "2025-03-09", 0, 2),
("안동 하회마을 주변 청소", "안동 하회마을 주변에서 쓰레기를 줍고 환경 보호 활동을 함께 진행합니다.", "경북 안동시", 36.5663, 128.6911, 8, "2025-03-09", "2025-03-10", 0, 3),
("서울 북악산 환경 미션", "북악산에서 환경 보호 활동을 진행하며 청결한 서울을 만듭시다.", "서울시 종로구", 37.5922, 126.9705, 10, "2025-03-10", "2025-03-11", 0, 4),
("여수 오동도 환경 보호 캠페인", "여수 오동도에서 환경 보호 캠페인에 참여해 주십시오. 함께 깨끗한 바다를 만들어 가요.", "전남 여수시", 34.8647, 127.7331, 6, "2025-03-11", "2025-03-12", 0, 1),
("제주 올레길 환경 정화 활동", "제주 올레길에서 환경을 정화하며 쓰레기 줍기 활동에 참여합니다.", "제주도 제주시", 33.3925, 126.5033, 5, "2025-03-12", "2025-03-13", 0, 2),
("전남 보성에서 쓰레기 줍기", "전남 보성에서 자연 보호 활동을 진행하며 환경을 지킵니다.", "전남 보성군", 34.7556, 127.1889, 7, "2025-03-13", "2025-03-14", 0, 3),
("경기 용인에서 환경 보호 미션", "경기 용인에서 함께 환경 보호 미션을 진행합니다. 쓰레기를 줍고 자연을 지켜요!", "경기도 용인시", 37.2413, 127.1771, 6, "2025-03-14", "2025-03-15", 0, 4),
("서울 한강시민공원에서 쓰레기 줍기", "서울 한강시민공원에서 쓰레기 줍기 활동을 함께 진행합니다. 환경을 깨끗하게 유지합시다.", "서울시 강서구", 37.5500, 126.8192, 15, "2025-03-15", "2025-03-16", 0, 1),
("부산 광안리 해변 청소", "부산 광안리 해변에서 청소 활동을 진행합니다. 함께 깨끗한 해변을 만들어요.", "부산시 수영구", 35.1581, 129.1187, 8, "2025-03-16", "2025-03-17", 0, 2),
("서울 서울숲 환경 보호 캠페인", "서울숲에서 환경 보호 캠페인을 진행하며 쓰레기를 줍고 자연을 보호합니다.", "서울시 성동구", 37.5443, 127.0399, 10, "2025-03-17", "2025-03-18", 0, 3),
("강원도 원주에서 환경 보호 활동", "강원도 원주에서 함께 환경 보호 활동을 진행합니다. 자연을 지키는 데 동참해주세요.", "강원도 원주시", 37.3421, 127.9210, 7, "2025-03-18", "2025-03-19", 0, 4),
("전북 군산에서 자연 보호 캠페인", "군산에서 환경 보호 캠페인에 참여하고 깨끗한 자연을 지켜요.", "전북 군산시", 35.9746, 126.7371, 6, "2025-03-19", "2025-03-20", 0, 1),
("충남 아산에서 쓰레기 줍기", "아산에서 함께 쓰레기 줍기 활동을 진행하고 깨끗한 환경을 만들어 갑니다.", "충청남도 아산시", 36.7847, 127.0006, 9, "2025-03-20", "2025-03-21", 10, 2),
("경기 고양시 환경 정화", "고양시에서 환경 정화 활동을 진행하며 깨끗한 거리를 만듭니다.", "경기도 고양시", 37.6534, 126.8350, 10, "2025-03-21", "2025-03-22", 200, 3),
("전남 순천에서 자연 보호 활동", "순천에서 자연 보호 활동에 참여하고 아름다운 자연을 지키세요.", "전남 순천시", 34.9504, 127.4870, 5, "2025-03-22", "2025-03-23", 250, 4),
("서울 서울숲에서 환경 미션", "서울숲에서 환경 미션을 수행하며 함께 환경을 보호하는 활동을 합니다.", "서울시 성동구", 37.5444, 127.0408, 12, "2025-03-23", "2025-03-24", 0, 1),
("강릉 송정해변 환경 정화", "강릉 송정해변에서 자연 보호 활동을 함께 진행합니다. 쓰레기 줍기와 함께 청정한 해변을 지켜요.", "강원도 강릉시 송정동", 37.5272, 128.7840, 10, "2025-03-01", "2025-03-02", 0, 1),
("서울 한강공원 벚꽃길 청소", "한강공원의 벚꽃길을 함께 청소하며 봄의 향기를 만끽하세요.", "서울시 마포구 한강로", 37.5497, 126.9470, 15, "2025-03-02", "2025-03-03", 0, 2),
("부산 해운대 해변 쓰레기 줍기", "부산 해운대 해변에서 함께 쓰레기 줍기를 하며 환경을 보호합시다.", "부산시 해운대구 해운대해변로", 35.1585, 129.1606, 20, "2025-03-03", "2025-03-04", 0, 3),
("서울 남산공원 환경 미션", "남산에서 자연을 보호하고 깨끗한 서울을 만들어가는 환경 미션에 참여하세요.", "서울시 중구 남산동", 37.5512, 126.9882, 10, "2025-03-04", "2025-03-05", 0, 4),
("전주 한옥마을 주변 쓰레기 줍기", "전주 한옥마을에서 쓰레기를 줍고 환경 보호 활동을 함께 진행해요.", "전북 전주시 완산구 한옥마을", 35.8245, 127.1480, 12, "2025-03-05", "2025-03-06", 0, 1),
("인천 송도 센트럴파크 환경 캠페인", "송도 센트럴파크에서 쓰레기 줍기와 함께 환경 보호 활동에 동참하세요.", "인천시 연수구 송도동", 37.3810, 126.6516, 18, "2025-03-06", "2025-03-07", 0, 2),
("대전 갑천 청소 캠페인", "대전 갑천에서 함께 쓰레기를 줍고 환경을 깨끗하게 만듭니다.", "대전광역시 서구 갑천", 36.3325, 127.3731, 8, "2025-03-07", "2025-03-08", 0, 3),
("강원도 평창 자연 보호", "평창에서 환경 보호 활동을 진행하며 자연을 지키는 미션을 수행합니다.", "강원도 평창군 봉평면", 37.4500, 128.2900, 6, "2025-03-08", "2025-03-09", 0, 4),
("서울 올림픽공원 쓰레기 줍기", "올림픽공원에서 쓰레기를 줍고 환경을 보호하는 활동을 함께 진행합니다.", "서울시 송파구 올림픽로", 37.5158, 127.1216, 10, "2025-03-09", "2025-03-10", 0, 1),
("부산 광안리에서 환경 보호", "광안리 해변에서 함께 환경 보호 활동에 동참해 주세요!", "부산시 수영구 광안리", 35.1582, 129.1189, 12, "2025-03-10", "2025-03-11", 0, 2),
("경기도 용인 자연 보호 캠페인", "용인시에서 함께 자연 보호 활동을 진행하고 쓰레기를 줍습니다.", "경기도 용인시 수지구", 37.2334, 127.0350, 8, "2025-03-11", "2025-03-12", 0, 3),
("서울 청계천 청소 활동", "청계천 주변에서 쓰레기를 줍고 자연을 보호하는 활동을 함께 합니다.", "서울시 종로구 청계천로", 37.5701, 126.9779, 15, "2025-03-12", "2025-03-13", 0, 4),
("전남 순천만 자연 보호 활동", "순천만에서 자연을 보호하며 환경 미션을 수행합니다.", "전남 순천시 순천만", 34.9600, 127.4945, 10, "2025-03-13", "2025-03-14", 0, 1),
("경북 경주에서 쓰레기 줍기", "경주에서 자연을 보호하며 쓰레기 줍기 활동에 참여해 주세요!", "경북 경주시 보문로", 35.8567, 129.2235, 12, "2025-03-14", "2025-03-15", 0, 2),
("부산 동백섬 쓰레기 줍기", "부산 동백섬에서 쓰레기를 줍고 청정한 환경을 만들어요.", "부산시 영도구 동백섬", 35.0736, 129.1067, 18, "2025-03-15", "2025-03-16", 0, 3),
("서울 강남구 도산공원 청소", "도산공원에서 쓰레기 줍기 활동을 진행합니다. 함께 환경을 깨끗하게 해요.", "서울시 강남구 도산대로", 37.5213, 127.0222, 10, "2025-03-16", "2025-03-17", 0, 4),
("광주 무등산 쓰레기 줍기", "무등산에서 환경 보호 활동에 참여하며 쓰레기를 줍습니다.", "광주광역시 북구 무등로", 35.1587, 126.9201, 7, "2025-03-17", "2025-03-18", 0, 1),
("경기 용인 에버랜드 주변 청소", "에버랜드 주변에서 쓰레기 줍기 활동을 하며 자연을 보호합니다.", "경기도 용인시 처인구", 37.2651, 127.1884, 20, "2025-03-18", "2025-03-19", 0, 2),
("서울 경복궁 주변 환경 보호", "경복궁 주변에서 함께 쓰레기를 줍고 환경 보호 활동을 진행합니다.", "서울시 종로구 경복궁로", 37.5779, 126.9769, 12, "2025-03-19", "2025-03-20", 0, 3),
("충남 아산 환경 미션", "아산에서 환경 미션을 수행하며 쓰레기를 줍고 자연을 보호합니다.", "충청남도 아산시 배방읍", 36.7847, 127.0024, 8, "2025-03-20", "2025-03-21", 10, 4),
("경기 고양시 하늘공원 쓰레기 줍기", "고양시 하늘공원에서 함께 쓰레기를 줍고 환경을 보호하는 활동에 동참하세요.", "경기도 고양시 일산동구", 37.6548, 126.7720, 6, "2025-03-21", "2025-03-22", 150, 1),
("서울 여의도 공원 쓰레기 줍기", "여의도 공원에서 쓰레기를 줍고 깨끗한 환경을 만들어갑니다.", "서울시 영등포구 여의도동", 37.5262, 126.9259, 15, "2025-03-22", "2025-03-23", 200, 2),
("부산 송도 해수욕장 쓰레기 줍기", "송도 해수욕장에서 함께 환경 보호 활동을 진행합니다. 깨끗한 바다를 지켜요.", "부산시 서구 송도동", 35.0907, 129.0273, 12, "2025-03-23", "2025-03-24", 180, 3),
("서울 청량리 환경 보호 캠페인", "청량리에서 환경을 보호하며 쓰레기를 줍는 활동에 동참하세요.", "서울시 동대문구 청량리", 37.5777, 127.0483, 10, "2025-03-24", "2025-03-25", 150, 4),
("제주 올레길 쓰레기 줍기", "제주 올레길에서 자연 보호를 위해 쓰레기를 줍고 환경 보호에 동참합니다.", "제주도 제주시", 33.3925, 126.5033, 20, "2025-03-25", "2025-03-26", 0, 1),
("서울 서울숲 환경 보호 활동", "서울숲에서 환경 보호 활동에 참여하여 쓰레기를 줍고 자연을 보호합니다.", "서울시 성동구 뚝섬로", 37.5444, 127.0408, 15, "2025-03-26", "2025-03-27", 0, 2),
("광주 금남로 환경 캠페인", "광주 금남로에서 환경 캠페인에 참여하며 쓰레기를 줍고 깨끗한 도시를 만들어 가요.", "광주광역시 동구 금남로", 35.1594, 126.8509, 18, "2025-03-27", "2025-03-28", 150, 3),
("전북 군산 해변 쓰레기 줍기", "군산 해변에서 쓰레기를 줍고 깨끗한 해변을 유지하는 활동을 진행합니다.", "전북 군산시 해망로", 35.9640, 126.7382, 10, "2025-03-28", "2025-03-29", 0, 4),
("서울 남산 둘레길 청소", "남산 둘레길에서 환경 보호 활동을 함께 진행하며 자연을 지켜요.", "서울시 용산구 남산길", 37.5566, 126.9758, 10, "2025-03-29", "2025-03-30", 0, 1),
("부산 태종대 청소 활동", "태종대에서 쓰레기를 줍고 자연 보호 활동을 합니다. 함께 환경을 지켜요.", "부산시 영도구 태종로", 35.0735, 129.1032, 12, "2025-03-30", "2025-03-31", 200, 5);
