...
(1,"남한산성 둘레길 1코스","서울을 한눈에 조망할 수 있는 코스로 넉넉하게 90분을 걸으며 쓰레기도 줍고 건강도 챙길 수 있는 코스 입니다.","경기 광주시", 37.4164, 127.2522, 5,"2025-02-06","2025-02-11",0,2),
...
(6,"부산 태종대 청소 활동", "태종대에서 쓰레기를 줍고 자연 보호 활동을 합니다. 함께 환경을 지켜요.", "부산시 영도구 태종로", 35.05318269802607, 129.087914977024, 12, "2025-03-30", "2025-03-31", 200, 5);
...
( '남한산성 둘레길 1코스 근처에는 경기도 의왕시와 안양시, 수원시의 지역이 포함되는데요~ 저는 의왕시 카페거리 추천해요^^ 분위기 좋은 카페들이 모여 있어서 커피나 디저트를 즐기기에 좋아요' , '2024-12-11 2:33:12' , 2 , 2 ),
