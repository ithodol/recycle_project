...
("부산 해운대 해변 쓰레기 줍기", "부산 해운대 해변에서 함께 쓰레기 줍기를 하며 환경을 보호합시다.", "부산시 해운대구 해운대해변로", 35.1585, 129.1606, 10, "2025-03-03", "2025-03-04", 0, 3),
...
("인천 송도 센트럴파크 환경 캠페인", "송도 센트럴파크에서 쓰레기 줍기와 함께 환경 보호 활동에 동참하세요.", "인천시 연수구 송도동", 37.3810, 126.6516, 10, "2025-03-06", "2025-03-07", 0, 2),
...
("부산 동백섬 쓰레기 줍기", "부산 동백섬에서 쓰레기를 줍고 청정한 환경을 만들어요.", "부산시 영도구 동백섬", 35.0736, 129.1067, 13, "2025-03-15", "2025-03-16", 0, 3),
...
("경기 용인 에버랜드 주변 청소", "에버랜드 주변에서 쓰레기 줍기 활동을 하며 자연을 보호합니다.", "경기도 용인시 처인구", 37.2651, 127.1884, 14, "2025-03-18", "2025-03-19", 0, 2),
...
("제주 올레길 쓰레기 줍기", "제주 올레길에서 자연 보호를 위해 쓰레기를 줍고 환경 보호에 동참합니다.", "제주도 제주시", 33.3925, 126.5033, 11, "2025-03-25", "2025-03-26", 0, 1),
("서울 서울숲 환경 보호 활동", "서울숲에서 환경 보호 활동에 참여하여 쓰레기를 줍고 자연을 보호합니다.", "서울시 성동구 뚝섬로", 37.5444, 127.0408, 15, "2025-03-26", "2025-03-27", 0, 2),
("광주 금남로 환경 캠페인", "광주 금남로에서 환경 캠페인에 참여하며 쓰레기를 줍고 깨끗한 도시를 만들어 가요.", "광주광역시 동구 금남로", 35.1594, 126.8509, 15, "2025-03-27", "2025-03-28", 150, 3),
...
("부산 태종대 청소 활동", "태종대에서 쓰레기를 줍고 자연 보호 활동을 합니다. 함께 환경을 지켜요.", "부산시 영도구 태종로", 35.0735, 129.0032, 12, "2025-03-30", "2025-03-31", 200, 5);
