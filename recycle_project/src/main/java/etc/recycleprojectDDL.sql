...
('서울 한강에서 환경 보호 챌린지!', '서울 한강에서 쓰레기를 함께 줍고 환경 보호에 동참하는 활동입니다. 참여자 모집!', '서울시 마포구',0,0, 5, '2025-02-10', '2025-02-12', 100, 1),
('부산 해운대에서 바다 지키기!', '부산 해운대에서 쓰레기 줍기 활동을 진행합니다. 함께 바다를 지킬 참여자 모집!', '부산시 해운대구',0,0, 3, '2025-02-12', '2025-02-13', 200, 2),
('강릉 해변 청소 캠페인', '강릉의 아름다운 해변에서 쓰레기 줍기 활동을 합니다. 자연을 지키는 데 동참하세요!', '강원도 강릉시',0,0, 4, '2025-02-15', '2025-02-16', 150, 3),
('서울 남산 환경 미션', '남산에서 함께 환경을 정화하는 활동을 진행합니다. 많은 참여 부탁드립니다.', '서울시 용산구',0,0, 6, '2025-02-18', '2025-02-19', 50, 4),
('대구 중구 거리 청소 대작전!', '대구 중구에서 쓰레기 줍기 활동을 진행합니다. 함께 깨끗한 거리 만들기에 동참해주세요.', '대구시 중구',0,0, 4, '2025-02-20', '2025-02-22', 300, 5),
('광화문 환경 보호 챌린지', '광화문에서 함께 쓰레기 줍기 활동을 진행합니다. 환경을 지킬 준비 되셨나요?', '서울시 종로구',0,0, 5, '2025-02-20', '2025-02-22', 100, 1),
('부산 해운대에서 환경 보호하는 날', '부산 해운대에서 환경 보호 활동을 함께 합니다. 많은 참여 부탁드립니다!', '부산시 해운대구',0,0, 4, '2025-02-21', '2025-02-23', 150, 2),
('경기도 하늘공원 환경 보호 데이', '경기도 하늘공원에서 쓰레기 줍기 및 환경 보호 활동을 진행합니다. 동참해 주세요!', '경기도 성남시',0,0, 3, '2025-02-22', '2025-02-24', 200, 3),
('제주도 해변 정화 활동', '제주도 해변에서 쓰레기 줍기와 자연 보호 활동을 합니다. 참여해주세요!', '제주도 제주시',0,0, 6, '2025-02-23', '2025-02-25', 250, 4),
('인천 송도 환경 보호 워크숍', '인천 송도에서 환경 보호 활동을 진행합니다. 함께 깨끗한 환경을 만들어가요!', '인천시 송도구',0,0, 4, '2025-02-24', '2025-02-26', 300, 5),
('서울 남산에서 쓰레기 줍기!', '서울 남산에서 환경 보호 활동을 진행합니다. 함께 참여해 주세요!', '서울시 용산구',0,0, 5, '2025-02-25', '2025-02-27', 100, 6),
('부산 기장군 환경 보호 대모임', '부산 기장군에서 환경 보호 활동을 함께 합니다. 많은 분들의 참여 부탁드립니다!', '부산시 기장군',0,0, 4, '2025-02-26', '2025-02-28', 150, 7),
('경남 거제에서 환경 보호 캠페인', '경남 거제에서 쓰레기 줍기 및 환경 보호 활동을 진행합니다. 동참해 주세요!', '경남 거제시',0,0, 3, '2025-02-27', '2025-03-01', 200, 8),
('서울 양재천 환경 보호 대작전', '서울 양재천에서 쓰레기 줍기 활동과 함께 환경을 지키는 활동을 진행합니다.', '서울시 서초구',0,0, 5, '2025-02-28', '2025-03-02', 250, 9),
('강원도 정선에서 환경 보호 활동', '강원도 정선에서 함께 환경 보호 활동을 진행합니다. 많은 참여 부탁드립니다.', '강원도 정선군',0,0, 4, '2025-03-01', '2025-03-03', 300, 10),
('대전 둔산동 환경 보호 캠페인', '대전 둔산동에서 환경 보호 활동을 진행합니다. 참여를 기다립니다!', '대전시 서구 둔산동',0,0, 5, '2025-03-02', '2025-03-04', 150, 11),
('청주 상당공원 환경 보호', '청주 상당공원에서 함께 쓰레기 줍기 활동을 진행합니다. 자연을 지켜주세요!', '충청북도 청주시 상당구',0,0, 4, '2025-03-03', '2025-03-05', 200, 12),
('서울 월드컵공원 환경 보호', '서울 월드컵공원에서 쓰레기 줍기 활동을 진행하며 환경 보호에 동참해주세요.', '서울시 마포구',0,0, 5, '2025-03-04', '2025-03-06', 250, 13),
('서울 종로구 환경 보호 캠페인', '서울 종로구에서 환경 보호 활동을 함께 진행합니다. 많은 참여 바랍니다!', '서울시 종로구',0,0, 3, '2025-03-05', '2025-03-07', 300, 14),
('경기도 의정부 환경 보호 활동', '경기도 의정부에서 환경 보호 활동을 진행합니다. 많은 참여 부탁드립니다.', '경기도 의정부시',0,0, 4, '2025-03-06', '2025-03-08', 150, 15),
('충남 아산 환경 보호 챌린지', '충남 아산에서 쓰레기 줍기와 환경 보호 활동을 진행합니다. 동참 부탁드립니다.', '충청남도 아산시',0,0, 5, '2025-03-07', '2025-03-09', 200, 16),
('강원도 평창 환경 보호 캠페인', '강원도 평창에서 환경 보호 활동을 진행합니다. 참여해주세요!', '강원도 평창군',0,0, 4, '2025-03-08', '2025-03-10', 250, 17),
('울산 남구 환경 보호 활동', '울산 남구에서 함께 쓰레기 줍기 및 환경 보호 활동을 진행합니다.', '울산시 남구',0,0, 6, '2025-03-09', '2025-03-11', 300, 18),
('광주 북구 환경 보호 대작전', '광주 북구에서 쓰레기 줍기 활동을 진행합니다. 환경을 지키는 데 함께 해 주세요!', '광주 북구',0,0, 5, '2025-03-10', '2025-03-12', 150, 19),
('전주 덕진공원 환경 보호', '전주 덕진공원에서 쓰레기 줍기 및 환경 보호 활동을 진행합니다. 많은 참여 바랍니다.', '전라북도 전주시 덕진구',0,0, 3, '2025-03-11', '2025-03-13', 200, 20),
('서울 강동구 환경 보호 챌린지', '서울 강동구에서 환경 보호 활동을 진행합니다. 참여를 기다립니다!', '서울 강동구',0,0, 5, '2025-03-12', '2025-03-14', 250, 21),
('대구 동구 환경 보호 캠페인', '대구 동구에서 쓰레기 줍기 활동을 함께 진행합니다. 많은 참여 부탁드립니다.', '대구 동구',0,0, 4, '2025-03-13', '2025-03-15', 300, 22),
('서울 강서구 환경 보호 활동', '서울 강서구에서 쓰레기를 줍고 환경 보호 활동에 동참해주세요!', '서울 강서구',0,0, 6, '2025-03-14', '2025-03-16', 150, 23),
('전남 순천 환경 보호 대작전', '전남 순천에서 환경 보호 활동을 진행합니다. 함께 깨끗한 환경을 만들어가요!', '전라남도 순천시',0,0, 4, '2025-03-15', '2025-03-17', 200, 24),
('서울 구로구 환경 보호 캠페인', '서울 구로구에서 환경 보호 활동을 진행합니다. 많은 참여 바랍니다!', '서울 구로구',0,0, 5, '2025-03-16', '2025-03-18', 250, 25),
('경기도 오산 환경 보호 활동', '경기도 오산에서 환경 보호 활동을 진행합니다. 동참해 주세요!', '경기도 오산시',0,0, 3, '2025-03-17', '2025-03-19', 300, 26),
('부산 수영구 환경 보호 활동', '부산 수영구에서 환경 보호 활동을 진행합니다. 함께 자연을 지켜주세요!', '부산 수영구',0,0, 4, '2025-03-18', '2025-03-20', 150, 27),
('충북 청원 환경 보호 활동', '충북 청원에서 환경 보호 활동을 함께 진행합니다. 많은 참여 바랍니다!', '충청북도 청원군',0,0, 6, '2025-03-19', '2025-03-21', 200, 28),
('서울 강남구 환경 보호 챌린지', '서울 강남구에서 쓰레기 줍기 활동을 진행합니다. 많은 참여 부탁드립니다!', '서울 강남구',0,0, 5, '2025-03-20', '2025-03-22', 250, 29),
('경기도 평택 환경 보호 대작전', '경기도 평택에서 환경 보호 활동을 진행합니다. 많은 참여 부탁드립니다!', '경기도 평택시',0,0, 3, '2025-03-21', '2025-03-23', 300, 30);
