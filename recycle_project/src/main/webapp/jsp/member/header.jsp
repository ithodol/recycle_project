		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4 LogInMenu">
					<!-- 비로그인시 나타날 리스트 -->
					<li class="login_menu nav-item"><a class="nav-link text-light" href="#" onclick="onLogIn()">로그인</a></li>
					<li class="login_menu nav-item"><a class="nav-link text-light" href="#" onclick="onSignUp()">회원가입</a></li>
					<!-- 로그인시 나타날 리스트 -->
