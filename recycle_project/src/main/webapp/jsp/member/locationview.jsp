...
<body>
   ...
   <div id="layoutnav">
      <div class="view_content content">
            <div class="content_title">
               ...
               <select class="form-select" id="validationCustom04" onchange='location.href = this.value;'>
   ...
   <!-- js -->
   <script src="/recycle_project/js/pagination3.js"></script>
   <script src="/recycle_project/js/board/locationview.js"></script>
